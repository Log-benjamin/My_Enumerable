...
is a custome module that contains three methods to test a specific condition and filter from a given array or list.
...
- **Module with all method**
- **Module with any method**
- **Module with filter method**
...
> cd my-folder
  gh repo clone https://github.com/Log-benjamin/My_Enumerable
...
- [ ] **Add more methods for our module**
- [ ] **Add new Modules.**
